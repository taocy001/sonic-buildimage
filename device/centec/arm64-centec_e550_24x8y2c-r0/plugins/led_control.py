...
class LedControl(LedControlBase):
    ...
    def _port_state_to_mode(self, port_idx, state):
        if state == "up":
            return self.LED_MODE_UP[0] if (port_idx < 33) else self.LED_MODE_UP[1]
        else:
            return self.LED_MODE_DOWN[0] if (port_idx < 33) else self.LED_MODE_DOWN[1]
    ...
    def __init__(self):
        ...
        self.LED_MODE_UP = [11, 1]
        self.LED_MODE_DOWN = [7, 2]
