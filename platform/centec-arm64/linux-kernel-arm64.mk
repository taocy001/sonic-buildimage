...
$(LINUX_KERNEL)_URL = https://github.com/CentecNetworks/sonic-binaries/blob/master/$(PLATFORM_ARCH)/kernel/$(LINUX_KERNEL)
SONIC_ONLINE_DEBS += $(LINUX_KERNEL)
SONIC_STRETCH_DEBS += $(LINUX_KERNEL)

LINUX_KERNEL_DEBIMG = linux-image-4.9.62_4.9.62-1_arm64.deb
$(LINUX_KERNEL_DEBIMG)_URL = https://github.com/CentecNetworks/sonic-binaries/blob/master/$(PLATFORM_ARCH)/kernel/$(LINUX_KERNEL_DEBIMG)
...
$(LINUX_KERNEL_HEADERS)_URL = https://github.com/CentecNetworks/sonic-binaries/blob/master/$(PLATFORM_ARCH)/kernel/$(LINUX_KERNEL_HEADERS)
